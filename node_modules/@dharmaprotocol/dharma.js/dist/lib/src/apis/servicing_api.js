        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        debtToken = _a.sent();
                        return [4 /*yield*/, debtToken.getOwnerTokens.callAsync(account)];
                    case 2:
                        usersDebtTokens = _a.sent();
                        return [2 /*return*/, usersDebtTokens.map(function (tokenId) { return "0x" + tokenId.toString(16).padStart(64, "0"); })];
                }
            });
        });
    };
