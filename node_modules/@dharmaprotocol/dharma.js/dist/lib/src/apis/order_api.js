...
var OrderAPI = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, types_1.DebtOrder.applyNetworkDefaults(debtOrder, this.contracts)];
                    case 2:
                        debtOrder = _b.sent();
                    ...
                    case 4:
                        _b.sent();
                        return [4 /*yield*/, this.assertConsensualityInvariants(debtOrder, transactionOptions)];
                    case 5:
                        _b.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 5:
                        _a.sent();
                        this.assert.order.senderAuthorizedToCancelOrder(debtOrder, transactionOptions, exports.OrderAPIErrors.UNAUTHORIZED_ORDER_CANCELLATION());
    ...
    OrderAPI.prototype.getIssuanceHash = function (debtOrder) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, types_1.DebtOrder.applyNetworkDefaults(debtOrder, this.contracts)];
                    case 1:
                        debtOrder = _a.sent();
                        debtOrderWrapped = new wrappers_1.DebtOrderWrapper(debtOrder);
    ...
    OrderAPI.prototype.assertConsensualityInvariants = function (debtOrder, transactionOptions) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.assert.order.validDebtorSignature(debtOrder, transactionOptions, exports.OrderAPIErrors.INVALID_DEBTOR_SIGNATURE())];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.assert.order.validCreditorSignature(debtOrder, transactionOptions, exports.OrderAPIErrors.INVALID_CREDITOR_SIGNATURE())];
                    case 2:
                        _a.sent();
                        if (!(debtOrder.underwriter && debtOrder.underwriter !== constants_1.NULL_ADDRESS)) return [3 /*break*/, 4];
                        return [4 /*yield*/, this.assert.order.validUnderwriterSignature(debtOrder, transactionOptions, exports.OrderAPIErrors.INVALID_UNDERWRITER_SIGNATURE())];
                    case 3:
                        _a.sent();
                        _a.label = 4;
