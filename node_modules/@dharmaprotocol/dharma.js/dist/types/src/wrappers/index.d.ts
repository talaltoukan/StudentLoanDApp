...
export declare type ContractWrapper = DebtKernelContract | DebtRegistryContract | DebtTokenContract | TokenTransferProxyContract | ERC20Contract | RepaymentRouterContract | SimpleInterestTermsContractContract | CollateralizedSimpleInterestTermsContractContract | TermsContract | TokenRegistryContract;
export { BaseContract, DebtOrderWrapper, DebtKernelContract, DebtRegistryContract, DebtTokenContract, DummyTokenContract, TokenRegistryContract, TokenTransferProxyContract, ERC20Contract, TermsContract, SimpleInterestTermsContractContract, CollateralizedSimpleInterestTermsContractContract, RepaymentRouterContract };
